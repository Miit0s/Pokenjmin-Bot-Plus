...
def windows_absolute_path_to_wsl_absolute_path(windows_path):
    normedPath=windows_path.replace("\\","/")
    return subprocess.getoutput("wsl wslpath \""+normedPath+"\"")
...
def exportSingleTextLayerWithNewContent(layerPath:str, textContent:str, newFontSize:int=None, passByWSL=True):
    ...
    if(passByWSL):
        ...
        wslGeneratedSvgPath=windows_absolute_path_to_wsl_absolute_path(generatedSvgPath)
        print(wslGeneratedSvgPath)
        wslExportPath=windows_absolute_path_to_wsl_absolute_path(exportPath)
        inkscapeCommand="wsl inkscape \""+wslGeneratedSvgPath+"\" --export-filename=\""+wslExportPath+"\" --export-dpi="+str(settings["PreviewDPI"])
