...
def replace_psd_text_layer(ps, layerPath, layer, newText, replaceTextsWithSvgExports=True,fontSizeInPx:int=None):
    ...
    # newLayer=layer.parent.artLayers.add()
    # newLayer.name=layer.name+"-New"
    # width=ps.active_document.width
    # height=ps.active_document.height
    # # newLayer.bounds[0]=0
    # # newLayer.bounds[1]=0
    # # newLayer.bounds[2]=width
    # # newLayer.bounds[3]=height
    # ps.active_document.selection.selectAll()
    # fillColor = ps.SolidColor()
    # fillColor.rgb.red = 222
    # fillColor.rgb.green = 0
    # fillColor.rgb.blue = 0
    # ps.active_document.selection.fill(fillColor)
    # replace_image(ps,newLayer,pngPath)
    desc = ps.ActionDescriptor
    ps.active_document.active_layer=layer
